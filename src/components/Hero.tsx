    ...
    <>
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 mb-8">
        ...
        >
          ...
          {t({ pt: "Marque uma reunião", en: "Schedule a meeting" })}
        </a>
        <a
        ...
        >
          ...
          {t({ pt: "Me mande uma mensagem", en: "Send me a message" })}
        </a>
      </div>
  ...
  return (
    <section id="hero" className="min-h-screen flex flex-col md:flex-row overflow-hidden">
      ...
      <div className={`relative flex-1 bg-neutral-900 min-h-[40vh] md:min-h-screen -ml-0 md:-ml-[8%] transition-opacity duration-700 delay-200 ${visible ? "opacity-100" : "opacity-0"}`}>
        ...
        <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-black/50 via-transparent to-transparent pointer-events-none" />
      </div>
    </section>
  );
}
