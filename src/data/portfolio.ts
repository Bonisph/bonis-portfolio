...
export const education: {
...
}[] = [
  {
    id: 1,
    institution: "UTFPR",
    logo: "https://logo.clearbit.com/utfpr.edu.br",
    ...
    description: {
      pt: "Bacharel em Administração de Empresas pela Universidade Tecnológica Federal do Paraná (UTFPR), uma das principais universidades tecnológicas do Brasil. Meu Trabalho de Conclusão de Curso investigou o papel das blockchains, stablecoins e Real World Assets na democratização do acesso a ativos financeiros na América Latina — unindo gestão, finanças e tecnologia blockchain.",
      en: "Bachelor's in Business Administration from the Federal University of Technology – Paraná (UTFPR), one of Brazil's leading technological universities. My thesis investigated the role of blockchains, stablecoins, and Real World Assets in democratizing access to financial assets in Latin America — bridging management, finance, and blockchain technology.",
      es: "Licenciado en Administración de Empresas por la Universidad Tecnológica Federal de Paraná (UTFPR), una de las principales universidades tecnológicas de Brasil. Mi TCC investigó el papel de las blockchains, stablecoins y Real World Assets en la democratización del acceso a activos financieros en América Latina.",
    },
    stats: [],
  },
];
